...
export class MobileNavigationComponent implements OnInit {
  ...
  buttons = [
    ...
    },
    {
      text: 'Sports',
      view: '0 0 96 96',
      clickFunction: this.navigateSport.bind(this),
    ...
    },
    {
      text: 'Chat',
      view: '0 0 64 64',
      clickFunction: this.Chat.bind(this),
  ...
  navigateCasino() {
    this.router.navigateByUrl('/casino/home')
    this.toggle.setSidebar(true)
    this.toggle.setBetslipstate(false)
  }

  navigateSport() {
    this.router.navigateByUrl('/sport/home')
    this.toggle.setSidebar(true)
    this.toggle.setBetslipstate(false)
  }
